...
<div class="overflow-hidden rounded shadow-2xl bg-violet-400 text-violet-200 shadow-violet-200 w-[600px]  ">
  <div class="relative p-6">
    <figure class="relative z-10">
      <blockquote class="p-6 text-lg leading-relaxed">
        <p>Join our community of food lovers, and let us bring the best meals straight to your door!</p>
      </blockquote>
      <figcaption class="flex items-center gap-4 p-6 pt-2 text-sm text-white">
        ...
        <div class="flex flex-col gap-1">
          ...
          <cite class="not-italic"><a href="http://www.george-orwell.org/1984/0.html">Nineteen Eighty-Four</a></cite>
        </div>
      </figcaption>
    </figure>
